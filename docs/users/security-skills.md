...
This report lists all security-related skills found in the `annias-awesome-skills` repository, including their descriptions, use cases, and example prompts.
