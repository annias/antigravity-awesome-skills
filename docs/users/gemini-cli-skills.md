...
Annias Awesome Skills supports Gemini CLI through the `.gemini/skills/` path and combines general engineering playbooks with specialized skills for AI systems, integrations, infrastructure, testing, product, and growth.

## How to use Annias Awesome Skills with Gemini CLI
...
```bash
npx annias-awesome-skills --gemini
```
