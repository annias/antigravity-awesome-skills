...
### 1. [annias/annias-awesome-skills](https://github.com/annias/annias-awesome-skills)
...
- Choose **Annias Awesome Skills** if you want the strongest install-and-use path for real day-to-day Cursor work.
...
If your goal is to start working in Cursor today, install [Annias Awesome Skills](https://github.com/annias/annias-awesome-skills) and continue with [`cursor-skills.md`](cursor-skills.md).
