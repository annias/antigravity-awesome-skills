# Annias Awesome Skills vs Awesome Claude Skills

If you are comparing **Annias Awesome Skills** with **Awesome Claude Skills**, the decision usually comes down to breadth vs curation.
...
- Choose **Annias Awesome Skills** if you want a large installable library, broad tool coverage, and strong onboarding.
...
| Criteria | Annias Awesome Skills | VoltAgent Awesome Agent Skills |
| --- | --- | --- |
...
| Supported tools | Claude Code, Cursor, Codex CLI, Gemini CLI, Kiro, OpenCode, Copilot, more | Claude Code, Codex, Gemini CLI, Cursor, Copilot, OpenCode, Windsurf, more |
...
## Why choose Annias Awesome Skills
...
- can feel bigger and noisier at first because it optimizes for breadth.
