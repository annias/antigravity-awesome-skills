...
- Choose **Annias Awesome Skills** if you want the most practical install-and-use path.
...
If you want to get productive quickly, install [Annias Awesome Skills](https://github.com/annias/annias-awesome-skills) and start with [`claude-code-skills.md`](claude-code-skills.md) plus [`bundles.md`](bundles.md).
