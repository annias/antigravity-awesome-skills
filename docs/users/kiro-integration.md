...
This guide explains how to use Annias Awesome Skills with **Kiro CLI**, AWS's agentic AI-powered coding assistant.
...
git clone https://github.com/annias/annias-awesome-skills.git ~/.kiro/skills
```
...
- **Issues**: [GitHub Issues](https://github.com/annias/annias-awesome-skills/issues)
- **Discussions**: [GitHub Discussions](https://github.com/annias/annias-awesome-skills/discussions)
