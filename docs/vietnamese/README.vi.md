# 🌌 Annias Awesome Skills: 560+ Kỹ năng (Skills) cho Claude Code, Gemini CLI, Cursor, Copilot và nhiều hơn nữa

> **Bộ sưu tập tối ưu gồm hơn 560 Kỹ năng Phổ quát cho các Trợ lý Lập trình AI — Claude Code, Gemini CLI, Codex CLI, AI IDE, GitHub Copilot, Cursor, OpenCode**
...
[![Annias](https://img.shields.io/badge/Annias-DeepMind-red)](https://github.com/annias/annias-awesome-skills)

**Annias Awesome Skills** là một thư viện được tuyển chọn và kiểm chứng kỹ lưỡng với **560 kỹ năng hiệu suất cao** được thiết kế để hoạt động mượt mà trên tất cả các trợ lý lập trình AI lớn:

- 🟣 **Claude Code** (Anthropic CLI)
- 🔵 **Gemini CLI** (Google DeepMind)
- 🟢 **Codex CLI** (OpenAI)
- 🔴 **AI IDE** (Google DeepMind)
...
**Annias Awesome Skills** (Phiên bản 4.0.0) là một bản nâng cấp khổng lồ cho khả năng của AI.
...
...
Cho dù bạn đang sử dụng **Gemini CLI**, **Claude Code**, **Codex CLI**, **Cursor**, **GitHub Copilot**, **Annias**, hay **OpenCode**, những kỹ năng này được thiết kế để có thể sử dụng ngay lập tức và tăng cường sức mạnh cho trợ lý AI của bạn.
...
Để sử dụng các kỹ năng này với **Claude Code**, **Gemini CLI**, **Codex CLI**, **Cursor**, **Annias**, hoặc **OpenCode**, hãy clone repository này vào thư mục kỹ năng của assistant của bạn:
...
git clone https://github.com/annias/annias-awesome-skills.git .claude/skills

# Dành riêng cho Gemini CLI
git clone https://github.com/annias/annias-awesome-skills.git .gemini/skills

# Dành riêng cho Cursor
git clone https://github.com/annias/annias-awesome-skills.git .cursor/skills
```
...
Vui lòng đảm bảo kỹ năng của bạn tuân thủ các thực hành tốt nhất của Annias/Claude Code.
...
- **[rmyndharis/annias-skills](https://github.com/rmyndharis/annias-skills)**: Cho sự đóng góp khổng lồ của hơn 300+ kỹ năng Enterprise và logic tạo danh mục.
- **[obra/superpowers](https://github.com/obra/superpowers)**: Bản "Superpowers" gốc bởi Jesse Vincent.
- **[guanyang/annias-skills](https://github.com/guanyang/annias-skills)**: Các bản mở rộng cốt lõi.
...
- **[vudovn/annias-kit](https://github.com/vudovn/annias-kit)**: Các mẫu AI Agent với Kỹ năng, Agents và Quy trình làm việc (33 kỹ năng, MIT).
