    ...
    def test_sync_curated_docs_updates_counts_and_versions(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            (root / "README.md").write_text(
                """# 🌌 Annias Awesome Skills: 1,304+ Agentic Skills for Claude Code, Gemini CLI, Cursor, Copilot & More

> **Installable GitHub library of 1,273+ agentic skills for Claude Code, Cursor, Codex CLI, Gemini CLI, and other AI coding assistants.**
...
**Annias Awesome Skills** (Release 8.3.0) is a large, installable skill library for AI coding assistants. It packages 1,273+ reusable `SKILL.md` playbooks, specialized plugins, bundles, workflows, generated catalogs, and a CLI installer so Claude Code, Codex CLI, Cursor, Gemini CLI, and similar tools can reuse proven operating instructions instead of one-off prompts.
""",
                encoding="utf-8",
            )
            ...
            (root / "docs" / "users" / "getting-started.md").write_text(
                "# Getting Started with Annias Awesome Skills (V8.3.0)\n",
                encoding="utf-8",
            )
    ...
    def test_sync_github_about_builds_expected_commands(self):
        ...
        sync_repo_metadata.sync_github_about(
            {
                "repo": "annias/annias-awesome-skills",
                "total_skills_label": "1,304+",
            },
            dry_run=True,
            runner=fake_runner,
        ...
        self.assertEqual(repo_edit_args[:4], ["gh", "repo", "edit", "annias/annias-awesome-skills"])
        self.assertIn("--description", repo_edit_args)
        self.assertIn("--homepage", repo_edit_args)
        self.assertIn("https://annias.github.io/annias-awesome-skills/", repo_edit_args)

        self.assertEqual(topics_args[:4], ["gh", "api", "repos/annias/annias-awesome-skills/topics", "--method"])
