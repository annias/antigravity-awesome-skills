...
"""
        ...
        self.assertIn("https://contrib.rocks/image?repo=annias/annias-awesome-skills&max=500", updated)
        self.assertIn("https://github.com/annias/annias-awesome-skills/graphs/contributors", updated)
