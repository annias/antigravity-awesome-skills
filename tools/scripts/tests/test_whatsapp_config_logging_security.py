...
class WhatsAppConfigLoggingSecurityTests(unittest.TestCase):
    MODULE_PATHS = [
        ...
        (
            "plugins/annias-awesome-skills/skills/whatsapp-cloud-api/scripts/validate_config.py",
            "whatsapp_validate_codex_plugin",
        ),
        (
            "plugins/annias-awesome-skills-claude/skills/whatsapp-cloud-api/scripts/validate_config.py",
