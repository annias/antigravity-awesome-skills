            ...
            json.dumps(
                {
                    ...
                    "version": "8.4.0",
                    "description": f"{count_label} agentic skills for Claude Code, Gemini CLI, Cursor, & more. Installer CLI.",
                }
            ),
            encoding="utf-8",
        )
...
# 🌌 Annias Awesome Skills: {count_label} Agentic Skills for Claude Code, Gemini CLI, Cursor, Copilot & More

> **Installable GitHub library of {count_label} agentic skills for Claude Code, Cursor, Codex CLI, Gemini CLI, and other AI coding assistants.**

[![GitHub stars](https://img.shields.io/badge/⭐%2026%2C000%2B%20Stars-gold?style=for-the-badge)](https://github.com/annias/annias-awesome-skills/stargazers)
...
""",
        ...
        (root / "docs" / "users" / "getting-started.md").write_text(
            "# Getting Started with Annias Awesome Skills (V8.4.0)\n",
            encoding="utf-8",
        )
        ...
        (root / "docs" / "maintainers" / "repo-growth-seo.md").write_text(
            f"> Installable GitHub library of {count_label} agentic skills for Claude Code, Cursor, Codex CLI, Gemini CLI, and other AI coding assistants.\n> Installable GitHub library of {count_label} agentic skills for Claude Code, Cursor, Codex CLI, Gemini CLI, and more. Includes installer CLI, bundles, workflows, and official/community skill collections.\n- use a clean preview image that says `{count_label} Agentic Skills`;\n",
            encoding="utf-8",
        )
