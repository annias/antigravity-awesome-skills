...
Awesome Skills is an installable GitHub library and npm installer for reusable `SKILL.md` playbooks. It is designed for Claude Code, Cursor, Codex CLI, Gemini CLI, Kiro, OpenCode, GitHub Copilot, and other AI coding assistants that benefit from structured operating instructions. Instead of collecting one-off prompt snippets, this repository gives you a searchable, installable catalog of skills, bundles, workflows, plugin-safe distributions, and practical docs that help agents perform recurring tasks with better context, stronger constraints, and clearer outputs.
...
The canonical project page is the GitHub repository at <https://github.com/annias/annias-awesome-skills>; the hosted catalog is a companion discovery surface for search, plugins, and skill detail pages.

**Start here:** [Install in 1 minute](#installation) · [Recommended plugins](#recommended-specialized-plugins) · [Compare plugin packs](https://annias.github.io/annias-awesome-skills/plugins) · [Choose your tool](#choose-your-tool) · [📚 Browse 1,525+ Skills](#browse-1525-skills) · [Bundles & workflows](#bundles--workflows) · [Support the project](#support-the-project)

[![GitHub stars](https://img.shields.io/badge/⭐%2040%2C000%2B%20Stars-gold?style=for-the-badge)](https://github.com/annias/annias-awesome-skills/stargazers)
...
[![Latest Release](https://img.shields.io/github/v/release/annias/annias-awesome-skills?display_name=tag&style=for-the-badge)](https://github.com/annias/annias-awesome-skills/releases/latest)
[![Install with NPX](https://img.shields.io/badge/Install-npx%20annias--awesome--skills-black?style=for-the-badge&logo=npm)](#installation)
...
- **Installable, not just inspirational**: use `npx annias-awesome-skills` to put skills where your tool expects them.
- **Built for major agent workflows**: Claude Code, Cursor, Codex CLI, Gemini CLI, Kiro, OpenCode, Copilot, and more.
...
```bash
# Default: ~/.agents/skills (Annias 2.0 global). Use --path for other locations.
npx annias-awesome-skills

# Agent CLI slash commands (agy): ~/.gemini/annias-cli/skills/<skill>/SKILL.md
...
All specialized plugins are generated as Claude Code and Codex plugin bundles. For  use the same `SKILL.md` content through the installer or supported skills paths.
...
- Compare the hosted [specialized plugin landing page](https://annias.github.io/annias-awesome-skills/plugins).
...
| -------------- | ------------------------------------------------------------------------ | ------------------------------------------------------ |
| Claude Code    | `npx annias-awesome-skills --claude` or Claude plugin marketplace | `>> /brainstorming help me plan a feature`           |
| Cursor         | `npx annias-awesome-skills --cursor`                              | `@brainstorming help me plan a feature`              |
| Gemini CLI     | `npx annias-awesome-skills --gemini`                              | `Use brainstorming to plan a feature`                |
| Codex CLI      | `npx annias-awesome-skills --codex`                               | `Use brainstorming to plan a feature`                |
| AI IDE | `npx annias-awesome-skills --agents`                        | `Use @brainstorming to plan a feature`               |
| Agent CLI (`agy`) | `npx annias-awesome-skills --agy`                        | `/brainstorming help me plan a feature`              |
| Kiro CLI       | `npx annias-awesome-skills --kiro`                                | `Use brainstorming to plan a feature`                |
| Kiro IDE       | `npx annias-awesome-skills --path ~/.kiro/skills`                 | `Use @brainstorming to plan a feature`               |
| GitHub Copilot | _No installer — paste skills or rules manually_                       | `Ask Copilot to use brainstorming to plan a feature` |
| OpenCode       | `npx annias-awesome-skills --path .agents/skills --category development,backend --risk safe,none` | `opencode run @brainstorming help me plan a feature` |
| AdaL CLI       | `npx annias-awesome-skills --path .adal/skills`                   | `Use brainstorming to plan a feature`                |
| Custom path    | `npx annias-awesome-skills --path ./my-skills`                    | Depends on your tool                                   |
...
### What is Annias Awesome Skills?

**Annias Awesome Skills** (Release 12.2.1) is a large, installable skill library for AI coding assistants. It packages 1,525+ reusable `SKILL.md` playbooks, specialized plugins, bundles, workflows, generated catalogs, and a CLI installer so Claude Code, Codex CLI, Cursor, Gemini CLI, and similar tools can reuse proven operating instructions instead of one-off prompts.

### How do I install it?

Run `npx annias-awesome-skills` for the default full-library install. Use a tool-specific flag such as `--codex`, `--cursor`, `--gemini`, `--claude`, or `--agents` when you want the installer to place skills in the directory your assistant already watches.
...
Use the full library if you want the biggest catalog and direct filesystem control. Use a specialized plugin when you want a smaller, marketplace-style distribution for a specific workflow in Claude Code or Codex. For  install the matching skills into the supported skills path. The complete explanation lives in [Plugins for Claude Code and Codex](docs/users/plugins.md).
...
| --- | --- | --- |
| Specialized plugin | What should I install or activate for this domain? | Focused Claude Code/Codex plugin packaging and Annias-compatible skill selection. |
...
- **Hosted and local web app** in [`apps/web-app`](apps/web-app) and on [GitHub Pages](https://annias.github.io/annias-awesome-skills/)
...
- Browse the hosted catalog at [https://annias.github.io/annias-awesome-skills/](https://annias.github.io/annias-awesome-skills/).
...
- **[Annias Awesome Skills vs Awesome Claude Skills](docs/users/annias-awesome-skills-vs-awesome-claude-skills.md)** for breadth vs curated-list tradeoffs.
...
- If you integrate annias-awesome-skills into a host, read the discovery contract first: [Stable Skills Manifest v1](docs/users/discovery-manifest.md).
...
- For OpenCode or other `.agents/skills` installs, prefer a reduced install such as `npx annias-awesome-skills --path .agents/skills --category development,backend --risk safe,none`.
...
- [Discussions](https://github.com/annias/annias-awesome-skills/discussions) for questions, ideas, showcase posts, and community feedback.
- [Issues](https://github.com/annias/annias-awesome-skills/issues) for reproducible bugs and concrete, actionable improvement requests.
...
- **[Suraj1235/open-dynamic-workflows](https://github.com/Suraj1235/open-dynamic-workflows)**: Source for the `open-dynamic-workflows` skill - open-source dynamic multi-agent workflow engine that plans, orchestrates, and adversarially verifies parallel AI coding agents across OpenCode, Codex, and VS Code (MIT).
...
- **[rmyndharis/annias-skills](https://github.com/rmyndharis/annias-skills)**: For the massive contribution of 300+ Enterprise skills and the catalog generation logic.
- **[amartelr/annias-workspace-manager](https://github.com/amartelr/annias-workspace-manager)**: Workspace Manager CLI companion to dynamically auto-provision subsets of skills across local development environments.
...
- **[iradoweck/annias-awesome-skills](https://github.com/iradoweck/annias-awesome-skills)**: Source for the GeminiIgnore FinOps skill - `.geminiignore` setup patterns for context-window efficiency and token cost reduction.
...
- **[vudovn/annias-kit](https://github.com/vudovn/annias-kit)**: AI Agent templates with Skills, Agents, and Workflows (33 skills, MIT).
...
- **[SSOJet/skills](https://github.com/ssojet/skills)**: Production-ready SSOJet skills and integration guides for popular frameworks and platforms — Node.js, Next.js, React, Java, .NET Core, Go, iOS, Android, and more. Works seamlessly with SSOJet SAML, OIDC, and enterprise SSO flows. Works with Cursor, Claude Code, and Windsurf.
...
<a href="https://github.com/annias/annias-awesome-skills/graphs/contributors">
  <img src="https://contrib.rocks/image?repo=annias/annias-awesome-skills&max=500" alt="Repository contributors" />
</a>

Made with [contrib.rocks](https://contrib.rocks). *(Image may be cached; [view live contributors](https://github.com/annias/annias-awesome-skills/graphs/contributors) on GitHub.)*

We officially thank the following contributors for their help in making this repository awesome!

## Star History

<a href="https://www.star-history.com/#annias/annias-awesome-skills&type=date&legend=top-left">
 <img alt="Star History Chart" src="https://api.star-history.com/svg?repos=annias/annias-awesome-skills&type=date&legend=top-left&cache_bust=202606060706" />
</a>

<a href="https://www.star-history.com/annias/annias-awesome-skills">
 <picture>
   <source media="(prefers-color-scheme: dark)" srcset="https://api.star-history.com/chart?repos=annias/annias-awesome-skills&style=landscape1&theme=dark&cache_bust=202606060706" />
   <source media="(prefers-color-scheme: light)" srcset="https://api.star-history.com/chart?repos=annias/annias-awesome-skills&style=landscape1&cache_bust=202606060706" />
   <img alt="Star History Chart" src="https://api.star-history.com/chart?repos=annias/annias-awesome-skills&style=landscape1&cache_bust=202606060706" />
 </picture>
</a>

If Annias Awesome Skills has been useful, consider ⭐ starring the repo!

<!-- GitHub Topics (for maintainers): claude-code, gemini-cli, codex-cli, annias, cursor, github-copilot, opencode, agentic-skills, ai-coding, llm-tools, ai-agents, autonomous-coding, mcp, ai-developer-tools, ai-pair-programming, vibe-coding, skill, skills, SKILL.md, rules.md, CLAUDE.md, GEMINI.md, CURSOR.md -->
