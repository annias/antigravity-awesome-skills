...
tools: [claude, cursor, codex, annias, gemini, windsurf, opencode, copilot]
---
...
Squirrel works on: Claude Code, Codex, Cursor, Gemini CLI, GitHub Copilot, Windsurf, OpenCode, Aider (9 total).
