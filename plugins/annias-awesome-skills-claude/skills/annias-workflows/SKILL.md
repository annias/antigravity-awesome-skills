---
name: annias-workflows
description: "Orchestrate multiple skills through guided workflows for SaaS MVP delivery, security audits, AI agent builds, and browser QA."
risk: none
source: self
...
```text
Use @annias-workflows to run the "Ship a SaaS MVP" workflow for my project idea.
```

```text
Use @annias-workflows and execute a full "Security Audit for a Web App" workflow.
```

```text
Use @annias-workflows to guide me through "Build an AI Agent System" with checkpoints.
```

```text
Use @annias-workflows to execute the "QA and Browser Automation" workflow and stabilize flaky tests.
```

```text
Use @annias-workflows to execute the "Design a DDD Core Domain" workflow for my new service.
```
