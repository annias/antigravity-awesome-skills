# Subagent Orchestrator — 2.0 Skill

A quota-aware, parallel subagent coordination skill for 2.0.
...
├── SKILL.md                          ← Main skill (auto-loaded by Annias)
├── scripts/
...
PRs welcome. Follow the SKILL.md format from the docs.
Submit to: https://github.com/annias/annias-awesome-skills
