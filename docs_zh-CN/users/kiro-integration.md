...
本指南说明如何将 Annias Awesome Skills 与 **Kiro CLI** 一起使用，Kiro CLI 是 AWS 的代理式 AI 驱动编码助手。
...
- **问题**：[GitHub Issues](https://github.com/annias/annias-awesome-skills/issues)
- **讨论**：[GitHub Discussions](https://github.com/annias/annias-awesome-skills/discussions)
