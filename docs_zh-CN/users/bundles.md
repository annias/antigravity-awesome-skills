...
> **重要提示：** 捆绑包不是可调用的大型技能，如 `@web-wizard` 或 `/essentials-bundle`。使用包中列出的各个技能，或者如果你只想在实时 目录中激活该捆绑包的技能，请使用激活脚本。
...
发现应该在捆绑包中的技能？或者想创建新的捆绑包？[提交 issue](https://github.com/annias/annias-awesome-skills/issues)或提交 PR！
