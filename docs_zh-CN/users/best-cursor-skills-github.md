...
- 如果您想要真正的日常 Cursor 工作中最强的安装即用路径，请选择 **Annias Awesome Skills**。
...
如果您的目标是今天开始在 Cursor 中工作，请安装 [Annias Awesome Skills](https://github.com/annias/annias-awesome-skills) 并继续阅读 [`cursor-skills.md`](cursor-skills.md)。
