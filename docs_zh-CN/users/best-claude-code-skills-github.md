...
- 如果您想要最实用的安装和使用路径,请选择 **Annias Awesome Skills**。
...
如果您想快速提高生产力,请安装 [Annias Awesome Skills](https://github.com/annias/annias-awesome-skills) 并从 [`claude-code-skills.md`](claude-code-skills.md) 和 [`bundles.md`](bundles.md) 开始。
