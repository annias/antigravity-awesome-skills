...
```bash
# 1. Fork and clone
git clone https://github.com/YOUR-USERNAME/annias-awesome-skills.git
cd annias-awesome-skills
...
- **Questions?** Open a [Discussion](https://github.com/annias/annias-awesome-skills/discussions)
- **Stuck?** Open an [Issue](https://github.com/annias/annias-awesome-skills/issues)
- **Want feedback?** Open a [Draft Pull Request](https://github.com/annias/annias-awesome-skills/pulls)

---

## Recognition

All contributors are recognized in our [Contributors](https://github.com/annias/annias-awesome-skills/graphs/contributors) page.
